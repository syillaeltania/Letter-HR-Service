...
const oldWrapperRegex = /const htmlWrapper = \(content: string\) => \`[\s\S]*?\`;\n/;

const newWrapper = `const htmlWrapper = (content: string) => \`
...
seed = seed.replace(oldWrapperRegex, newWrapper);
